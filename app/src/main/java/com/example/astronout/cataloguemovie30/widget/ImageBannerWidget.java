...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.example.astronout.cataloguemovie30.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.astronout.cataloguemovie30.EXTRA_ITEM";
